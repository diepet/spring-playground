insert into product (id, code, description) values (hibernate_sequence.nextval, '11112222', 'Apple iPad 4');
insert into product (id, code, description) values (hibernate_sequence.nextval, '22223333', 'Samsung Galaxy 10');
